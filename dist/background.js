import { s as settingsRepository, p as profileRepository } from "./assets/settingsRepository-BCIK-jsw.js";
  ...
  (async () => {
    ...
    switch (message.action) {
      ...
      case "GET_DEFAULT_PROFILE": {
        const profile = await profileRepository.getDefault();
        result = { success: true, data: profile };
        break;
      }
      case "GET_PROFILE": {
        const profile = await profileRepository.getById((_a = message.payload) == null ? void 0 : _a.id);
        result = { success: true, data: profile };
        break;
      }
